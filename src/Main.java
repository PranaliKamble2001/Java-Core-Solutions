...
public class Main {
    ...
    private static void displayProjectStatus() {
        ...
        System.out.println("\n--- COMPLETED: Modules in [src/NumberPrograms] ---");
        System.out.println("1. ArmstrongNumber - Digit-power summation logic");
        ...
        System.out.println("6. Factorial - Iterative calculation of n!");
